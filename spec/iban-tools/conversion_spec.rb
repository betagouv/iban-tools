...
module IBANTools
  describe Conversion do
    IBAN_FOR_TEST = {
      ...
      'AL47212110090000000235698741' => { bank_code: '212', branch_code: '1100', check_digit: '9',
                                          account_number: '235698741' },
      ...
      'BG80BNBG96611020345678' => { bank_code: 'BNBG', branch_code: '9661', account_type: '10',
      ...
      'FR1420041010050500013M02606' => { bank_code: '20041', branch_code: '1005', account_number: '500013M026',
                                         check_digits: '6' },
      ...
      'HU42117730161111101800000000' => { bank_code: '117', branch_code: '7301', account_prefix: '6',
                                          account_number: '111110180000000', check_digit: '0' },
      ...
      'IS140159260076545510730339' => { bank_code: '159', branch_code: '26', account_number: '7654',
                                        kennitala: '5510730339' },
      'IT60X0542811101000000123456' => { check_char: 'X', bank_code: '5428', branch_code: '11101',
                                         account_number: '123456' },
      'JO94CBJO0010000000000131000302' => { bank_code: 'CBJO', branch_code: '10', zeros: '0',
                                            account_number: '131000302' },
      ...
      'MC1112739000700011111000H79' => { bank_code: '12739', branch_code: '70', account_number: '11111000H',
                                         check_digits: '79' },
      ...
      'MR1300020001010000123456753' => { bank_code: '20', branch_code: '101', account_number: '1234567',
                                         check_digits: '53' },
      'MT84MALT011000012345MTLCAST001S' => { bank_code: 'MALT', branch_code: '1100',
                                             account_number: '12345MTLCAST001S' },
      'MU17BOMM0101101030300200000MUR' => { bank_code: 'BOMM01', branch_code: '1',
      ...
      'PL27114020040000300201355387' => { bank_code: '114', branch_code: '200', check_digit: '4',
                                          account_number: '300201355387' },
      'PS92PALS000000000400123456702' => { bank_code: 'PALS', account_number: '400123456702' },
      'PT50000201231234567890154' => { bank_code: '2', branch_code: '123', account_number: '12345678901',
                                       check_digits: '54' },
      ...
      'SM86U0322509800000000270100' => { check_char: 'U', bank_code: '3225', branch_code: '9800',
                                         account_number: '270100' },
      ...
      context 'given valid data' do
        ...
        IBAN_FOR_TEST.each do |iban, local|
          it "returns valid local data for #{iban}" do
            Conversion.iban2local(iban[0..1], iban[4..])
                      .should == local
          end
        end
      end

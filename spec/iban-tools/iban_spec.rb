  ...
  describe IBAN do
    describe 'with test rules' do
      ...
      it 'should validate IBAN code' do
        ...
        expect(IBAN.valid?('GB82WEST12345698765432', @rules)).to be_truthy
      end
      ...
      it 'should reject IBAN code with invalid check digits' do
        expect(IBAN.valid?('GB99 WEST 1234 5698 7654 32', @rules)).to be_falsy
    ...
    describe 'with default rules' do
      # Rules are loaded from lib/iban_tools/rules.yml
      ...
      %w[AD1200012030200359100100
         ...
         XK051212012345678906].each do |iban_code|
      ...
      it 'should fail known pattern violations' do
        ...
        expect(IBAN.valid?('RO7999991B31007593840000')).to be_falsy
      end
    end
  end
end
